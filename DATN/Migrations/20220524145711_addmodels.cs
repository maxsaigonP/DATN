    ...
    public partial class addmodels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_importedInvoice", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportecInvoiceDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportecInvoiceDetail_importedInvoice_ImportedInvoiceId",
                        column: x => x.ImportedInvoiceId,
                        principalTable: "importedInvoice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImportecInvoiceDetail_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportecInvoiceDetail_ImportedInvoiceId",
                table: "ImportecInvoiceDetail",
                column: "ImportedInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportecInvoiceDetail_ProductId",
                table: "ImportecInvoiceDetail",
                column: "ProductId");
